  ...
  describe Jobs::DeleteOrphanNetworks do
    ...
    describe '.enqueue' do
      ...
      it 'enqueues a DeleteOrphanNetworks job' do
        ...
        expect(job_queue).to receive(:enqueue).with('fake-username', Jobs::DeleteOrphanNetworks, 'delete orphan networks', [fake_orphan_networks_names])
      ...
      it 'errors if network is not orphaned' do
       Models::Network.make(name: 'nw-2', orphaned: false)
        ...
        end.to raise_error(DeletingUnorphanedNetworkError)
      end
    end
    ...
    describe '#perform' do
      ...
      context 'when deleting a network' do
        it 'logs and returns the result' do
          ...
          result = delete_orphan_networks.perform
