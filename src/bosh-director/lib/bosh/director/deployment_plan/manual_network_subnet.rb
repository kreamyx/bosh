  ...
  module DeploymentPlan
    class ManualNetworkSubnet
      ...
      def self.parse(network_name, subnet_spec, availability_zones, legacy_reserved_ranges, managed = false)
        ...
        new(network_name, range, gateway, name_servers, cloud_properties, netmask, availability_zone_names, restricted_ips, static_ips, subnet_name = sn_name, netmask_bits = nm_bits)
      end
