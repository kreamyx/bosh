module Bosh::Director
  module DeploymentPlan
    ...
    class ManualNetwork < NetworkWithSubnets
      ...
      def self.parse(network_spec, availability_zones, global_network_resolver, logger, deployment = nil)
        ...
        subnet_specs.each do |subnet_spec|
          new_subnet = ManualNetworkSubnet.parse(name, subnet_spec, availability_zones, reserved_ranges, managed, deployment)
